package com.wuyonghua.wyhblog.jwt.filter;
        ...
        if (StringUtils.startsWith(header, tokenPrefix)) {
            ...
            if (StringUtils.isNotBlank(token)) {
                try {
                    ...
                    authenticationEntryPoint.commence(request, response, new AuthenticationServiceException(TOKEN_NOT_AVAILABLE));
                    return;
                } catch (ExpiredJwtException e) {
                    authenticationEntryPoint.commence(request, response, new AuthenticationServiceException(TOKEN_INVALIDATION));
                    return;
                }
